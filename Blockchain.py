...
class Blockchain(object):
    def __init__(self):
        ...
        def resolve_conflicts(self):
            ...
            resolve_conflicts() is a method which loops through all our
            neighbouring nodes, downloads their chains and verifies them.
...
# /nodes/register to accept a list of new nodes from our neighbours in the form of URLs.
